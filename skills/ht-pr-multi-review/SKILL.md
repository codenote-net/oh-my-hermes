---
name: ht-pr-multi-review
description: Review a GitHub pull request with Claude Code CLI `/review`, `/security-review`, and `/code-review` plus Codex CLI review, then aggregate independent results and shared findings into one Markdown report. Use when a user invokes `/ht-pr-multi-review` with a PR URL, requests a multi-model PR review, or wants Claude and Codex review results compared.
---
