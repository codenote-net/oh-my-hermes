...
```text
ht-create-dependabot-cooldown-issue:OWNER/REPOSITORY       0 9 * * *
ht-create-dependabot-cooldown-issue:EXAMPLE-OWNER/EXAMPLE-REPOSITORY  7 9 * * *
```
...
Attach `ht-create-dependabot-cooldown-issue`, pin the provider/model, enable only terminal, and
...
cronjob(
  action="create",
  schedule="0 9 * * *",
  name="ht-create-dependabot-cooldown-issue:OWNER/REPOSITORY",
  skill="ht-create-dependabot-cooldown-issue",
...
hermes cron create "0 9 * * *" \
  --no-agent \
  --script "ht-create-dependabot-cooldown-issue-owner-repository.sh" \
  --name "ht-create-dependabot-cooldown-issue:OWNER/REPOSITORY"
```
